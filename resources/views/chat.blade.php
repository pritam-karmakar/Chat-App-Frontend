...
<head>
    ...
    <!-- Theme Script Js -->
   <script src="{{ asset('build/js/theme-script.js') }}" type="text/javascript"></script>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card audio-crd bg-transparent-dark border pt-4">
                                            ...
                                            <div class="card-body ">
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <span class="avatar avatar-xxxl bg-soft-primary rounded-circle p-2">
                                                        <img src="{{ asset('build/img/profiles/avatar-01.jpg') }}" class="rounded-circle" alt="user">
                                                    </span>
                                                </div>
                                                <div class="d-flex align-items-end justify-content-end">
                                                    <span class="badge badge-info">Edwin</span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card audio-crd bg-transparent-dark border pt-4">
                                            ...
                                            <div class="card-body ">
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <span class="avatar avatar-xxxl bg-soft-primary rounded-circle p-2">
                                                        <img src="{{ asset('build/img/profiles/avatar-02.jpg') }}" class="rounded-circle" alt="user">
                                                    </span>
                                                </div>
                                                <div class="d-flex align-items-end justify-content-end">
                                                    <span class="badge badge-info">Edwin</span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card audio-crd bg-transparent-dark border pt-4">
                                            ...
                                            <div class="card-body ">
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <span class="avatar avatar-xxxl bg-soft-primary rounded-circle p-2">
                                                        <img src="{{ asset('build/img/profiles/avatar-03.jpg') }}" class="rounded-circle" alt="user">
                                                    </span>
                                                </div>
                                                <div class="d-flex align-items-end justify-content-end">
                                                    <span class="badge badge-info">Edwin</span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card audio-crd bg-transparent-dark border pt-4">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <span class="avatar avatar-xxxl bg-soft-primary rounded-circle p-2">
                                                        <img src="{{ asset('build/img/profiles/avatar-05.jpg') }}" class="rounded-circle" alt="user">
                                                    </span>
                                                </div>
                                                <div class="d-flex align-items-end justify-content-end">
                                                    <span class="badge badge-info">Edwin</span>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body border-0 pt-0">
                        <div class="video-call-view br-8 overflow-hidden position-relative">
                            <img src="{{ asset('build/img/video/video-member-01.jpg') }}" alt="user-image">
                            <div class="mini-video-view active br-8 overflow-hidden position-absolute">
                                <img src="{{ asset('build/img/video/user-image.jpg') }}" alt="" >
                                ...
                                <div class="row row-gap-4">
                                    <div class="col-md-6 d-flex">
                                        <div class="video-call-view br-8 overflow-hidden flex-fill">
                                            <img src="{{ asset('build/img/video/video-member-02.jpg') }}" alt="user-image">
                                        </div>
                                    </div>
                                    <div class="col-md-6 d-flex">
                                        <div class="video-call-view br-8 overflow-hidden flex-fill">
                                            <img src="{{ asset('build/img/video/video-member-03.jpg') }}" alt="user-image">
                                        </div>
                                    </div>
                                    <div class="col-md-4 d-flex">
                                        <div class="video-call-view br-8 overflow-hidden flex-fill">
                                            <img src="{{ asset('build/img/video/video-member-05.jpg') }}" alt="user-image">
                                        </div>
                                    </div>
                                    <div class="col-md-4 d-flex">
                                        <div class="video-call-view br-8 overflow-hidden flex-fill">
                                            <img src="{{ asset('build/img/video/video-member-04.jpg') }}" alt="user-image">
                                        </div>
                                    </div>
                                    <div class="col-md-4 d-flex">
