...
<!-- Mirrored from dreamschat.dreamstechnologies.com/laravel/template/public/my-status by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Oct 2025 06:04:46 GMT -->
...
<head>
    ...
    <!-- Theme Script Js -->
   <script src="build/js/theme-script.js" type="e1aca54a027995c7b7f952c5-text/javascript"></script>
	   <!-- Bootstrap CSS -->
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class=" dropdown-menu dropdown-menu-end p-3" id="innerTab" role="tablist">
                                        <li role="presentation">
                                            <a class="dropdown-item active" id="all-chats-tab" data-bs-toggle="tab" href="#all-chats" role="tab" aria-controls="all-chats" aria-selected="true" onclick="if (!window.__cfRLUnblockHandlers) return false; changeChat('All Chats')" data-cf-modified-e1aca54a027995c7b7f952c5-="">All Chats</a>
                                        </li>
                                        <li role="presentation">
                                            <a class="dropdown-item" id="favourites-chat-tab" data-bs-toggle="tab" href="#favourites-chat" role="tab" aria-controls="favourites-chat" aria-selected="false" onclick="if (!window.__cfRLUnblockHandlers) return false; changeChat('Favourite Chats')" data-cf-modified-e1aca54a027995c7b7f952c5-="">Favourite Chats</a>
                                        </li>
                                        <li role="presentation">
                                            <a class="dropdown-item" id="pinned-chats-tab" data-bs-toggle="tab" href="#pinned-chats" role="tab" aria-controls="pinned-chats" aria-selected="false" onclick="if (!window.__cfRLUnblockHandlers) return false; changeChat('Pinned Chats')" data-cf-modified-e1aca54a027995c7b7f952c5-="">Pinned Chats</a>
                                        </li>
                                        <li role="presentation">
                                            <a class="dropdown-item" id="archive-chats-tab" data-bs-toggle="tab" href="#archive-chats" role="tab" aria-controls="archive-chats" aria-selected="false" onclick="if (!window.__cfRLUnblockHandlers) return false; changeChat('Archive Chats')" data-cf-modified-e1aca54a027995c7b7f952c5-="">Archive Chats</a>
                                        </li>
                                        <li role="presentation">
                                            <a class="dropdown-item" id="trash-chats-tab" data-bs-toggle="tab" href="#trash-chats" role="tab" aria-controls="trash-chats" aria-selected="false" onclick="if (!window.__cfRLUnblockHandlers) return false; changeChat('Trash')" data-cf-modified-e1aca54a027995c7b7f952c5-="">Trash</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                           ...
                           <div class="status-list">
                                ...
                                <div class="chat-users-wrap">
                                    <div class="position-relative">
                                        <a href="my-status.html" class="chat-user-list mb-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex profile-list justify-content-between align-items-center border-bottom mb-3 pb-3">
                                        <div>
                                            ...
                                            <p class="fs-16"><a href="https://dreamschat.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="88e1e6eee7c8edf0e9e5f8e4eda6ebe7e5">[email&#160;protected]</a></p>
                                        </div>
                        ...
                        <div class="sidebar-body chat-body">
                            ...
                            <div class="dropdown mb-3">
                                ...
                                <ul class="dropdown-menu dropdown-menu p-3">
                                    <li><a class="dropdown-item" href="all-calls.html"><i class="ti ti-phone me-2"></i>All Calls</a></li>
                                    <li><a class="dropdown-item" href="audio-calls.html"><i class="ti ti-phone-check me-2"></i>Audio Calls</a></li>
                                    <li><a class="dropdown-item" href="video-calls.html"><i class="ti ti-video me-2"></i>Video Calls</a></li>
                                </ul>
                            </div>
                            <!-- /Left Chat Title -->
                    ...
                    <div id="carouselIndicators" class="carousel slide slider" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner status_slider" role="listbox">
                            ...
                            <div id="target" class="carousel-item active">
                                <img src="build/img/status/status-01.jpg" alt="Image">
                            </div>
                            <div class="carousel-item">
                                <img src="build/img/status/status-02.jpg" alt="Image">
                            </div>
                            <div class="carousel-item">
                                <img src="build/img/status/status-03.jpg" alt="Image">
                            </div>
                            <div class="carousel-item">
                                <img src="build/img/status/status-04.jpg" alt="Image">
                            </div>
                            <div class="carousel-item">
                                <img src="build/img/status/status-05.jpg" alt="Image">
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="https://dreamschat.dreamstechnologies.com/laravel/template/public/my-status">
                ...
                <div class="file-drop mb-4">
                    <form action="#" class="dropzone dz-clickable drag-and-drop-block  d-flex align-items-center justify-content-center mb-3">
                        <div class="text-center">
                            <img src="build/img/icons/drag-file.svg" class="mb-2" alt="upload">
                ...
                <div class="row">       
                    <div class="col-md-12">   
                        <div class="drag-and-drop-block status-view p-3 mb-3">
                            <img src="build/img/status/status-01.jpg" class="status-preview" alt="upload">
                        </div>
...
<!-- /Logout -->
    ...
    <!-- jQuery -->
<script data-cfasync="false" src="../../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="build/js/jquery-3.7.1.min.js" type="e1aca54a027995c7b7f952c5-text/javascript"></script>
        
<!-- Bootstrap Core JS -->
<script src="build/js/bootstrap.bundle.min.js" type="e1aca54a027995c7b7f952c5-text/javascript"></script>

<!-- Slimscroll JS -->
<script src="build/plugins/slimscroll/jquery.slimscroll.min.js" type="e1aca54a027995c7b7f952c5-text/javascript"></script>

<!-- Swiper JS -->
<script src="build/plugins/swiper/swiper.min.js" type="e1aca54a027995c7b7f952c5-text/javascript"></script>

<!-- FancyBox JS -->
<script src="build/plugins/fancybox/jquery.fancybox.min.js" type="e1aca54a027995c7b7f952c5-text/javascript"></script>

<!-- Select JS -->
<script src="build/plugins/select2/js/select2.min.js" type="e1aca54a027995c7b7f952c5-text/javascript"></script>

<!-- Datetimepicker JS -->
<script src="build/js/moment.min.js" type="e1aca54a027995c7b7f952c5-text/javascript"></script>
<script src="build/js/bootstrap-datetimepicker.min.js" type="e1aca54a027995c7b7f952c5-text/javascript"></script>

<!-- Custom JS -->
<script src="build/js/script.js" type="e1aca54a027995c7b7f952c5-text/javascript"></script> 	
<script src="../../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="e1aca54a027995c7b7f952c5-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"version":"2024.11.0","token":"3ca157e612a14eccbb30cf6db6691c29","server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from dreamschat.dreamstechnologies.com/laravel/template/public/my-status by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Oct 2025 06:04:58 GMT -->
</html>